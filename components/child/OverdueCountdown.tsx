...
import { FAST_TICK, useNow } from "../clock";
 ...
 *
 * Рахується від абсолютного моменту за годинником пристрою, тому зона
 * сервера на нього не впливає.
 */
